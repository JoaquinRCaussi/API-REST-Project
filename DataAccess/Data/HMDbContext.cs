...
public class HMDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlite("Data Source=localdb.sqlite").ConfigureWarnings(warnings => warnings.Ignore(RelationalEventId.NonTransactionalMigrationOperationWarning));
    }
}
