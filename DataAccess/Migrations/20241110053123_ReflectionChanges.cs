...
{
    /// <inheritdoc />
    public partial class ReflectionChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidatorModelName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b4a6e6cd-856e-4ad1-a87e-9f1b24d40a74"), null, new DateTime(2024, 11, 10, 2, 31, 22, 578, DateTimeKind.Local).AddTicks(6917), "admin@admin.com", null, "", "Admin", "Admin", "admin", new Guid("c9a4a8f5-4393-4b5e-8c57-e7f5f58a9a61") });
