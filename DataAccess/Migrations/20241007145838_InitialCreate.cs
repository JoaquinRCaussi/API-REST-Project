...
public partial class InitialCreate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { new Guid("205e7ec9-673c-4db2-911d-10fe2b9c159a"), new Guid("10570280-239e-4fb8-8939-4f37415fccb7"), new DateTime(2024, 10, 7, 11, 58, 37, 342, DateTimeKind.Local).AddTicks(1351), "anothercompanyowner1@gmail.com", null, "", "anotherCompanyOwner", "anotherCompanyOwner", "companyowner@1", new Guid("c9a4a8f5-4393-4b5e-8c57-e7f5f58a9a61") },
                { new Guid("b4a6e6cd-856e-4ad1-a87e-9f1b24d40a74"), null, new DateTime(2024, 10, 7, 11, 58, 37, 353, DateTimeKind.Local).AddTicks(5581), "admin@admin.com", null, "", "Admin", "Admin", "admin", new Guid("b4a6e6cd-856e-4ad1-a87e-9f1b24d40a74") },
                { new Guid("c9a4a8f5-4393-4b5e-8c57-e7f5f58a9a61"), null, new DateTime(2024, 10, 7, 11, 58, 37, 353, DateTimeKind.Local).AddTicks(5832), "companyowner1@gmail.com", null, "", "CompanyOwner", "CompanyOwner", "companyowner@1", new Guid("c9a4a8f5-4393-4b5e-8c57-e7f5f58a9a61") },
                { new Guid("e43167ad-158b-4a39-8f5d-c0a69b32d7cf"), null, new DateTime(2024, 10, 7, 11, 58, 37, 353, DateTimeKind.Local).AddTicks(5807), "homeowner1@gmail.com", null, "", "HomeOwner", "HomeOwner", "homeowner@1", new Guid("e43167ad-158b-4a39-8f5d-c0a69b32d7cf") }
            });
