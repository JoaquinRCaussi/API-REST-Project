...
{
    /// <inheritdoc />
    public partial class MemberPermissionMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4d99af50-c4b9-4bc7-8c63-6e4f6f24a73a"), "puedeListarDispositivos" },
                    { new Guid("7fa6a0f4-d7d9-4c89-a85e-92b937fc0274"), "puedeAsociarDispositivos" },
                    { new Guid("b2ff8154-fdb0-4a87-a7b5-ded13fb66f57"), "puedeAgregarMiembros" },
                    { new Guid("c0f0d7a7-3e77-4128-87d3-30113b19936d"), "puedeRecibirNotificaciones" }
                });
